...
def main():
	...
	'''os.system('touch cube.fits')
	os.system('touch events.fits')
	os.system('touch selected_events.fits')
	os.system('touch sky1.png')'''
	...
	for i in range (0, n_maps): 
		...
		source_array = map_creator.source_generation(coordinates, int(sys.argv[3]), background_prefactor, log)
		...
		os.system("python ExecuteCTools.py -simmodel Generated_Maps/" + filename + " -observation " + str(sys.argv[1]) + " -runconf " + str(sys.argv[2]) + " &> " + logname )
